...
import { User, Mail, Phone, Shield, CreditCard, QrCode, Save } from 'lucide-react';
        ...
        <Card className="lg:col-span-1">
          <CardContent className="p-6 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-3">
              <Badge className="flex items-center gap-1"><CreditCard className="w-3 h-3" /> ABHA Linked</Badge>
              <Badge variant="outline" className="flex items-center gap-1"><Shield className="w-3 h-3" /> Aadhaar Linked</Badge>
            </div>
            ...
            <div className="mt-6 p-4 border rounded-lg bg-muted/30">
              ...
              <Button variant="outline" size="sm" className="mt-2" onClick={() => toast.success('QR code generated')}>
                Generate QR
              </Button>
            </div>
          </CardContent>
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-4">
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-sm font-medium mb-1 block">ABHA ID</label>
                <Input defaultValue="ABHA-1234-5678" disabled />
              </div>
              <div>
